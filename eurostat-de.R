...
data %>%
  ...
  annotate(geom="text",x= 20, y = 12500, label = "2020", adj=0, color="firebrick1") +
  ...
  labs(title = "Počty zemřelých po týdnech v Německu 2016–2020",
       subtitle = "Červeně rok 2020, šedě roky 2016 až 2019, černě průměr",
       y="",x="",
...
ggsave("eurostat-de.svg",width=62/7,height=34.9/7,dpi=320)
