...
data %>%
  ...
  annotate(geom="text",x= 15.5, y = 1200, label = "2020", adj=0, color="firebrick1") +
  ...
  labs(title = "Počty zemřelých po týdnech na Slovensku 2000–2020",
...
ggsave("eurostat-sk.svg",width=62/7,height=34.9/7,dpi=320)
