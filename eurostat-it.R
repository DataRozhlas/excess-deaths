...
data %>%
  ...
  labs(title = "Počty zemřelých po týdnech v Itálii 2015–2020",
       subtitle = "Červeně rok 2020, šedě roky 2015 až 2019, černě průměr",
       y="",x="",
...
ggsave("eurostat-it.svg",width=62/7,height=34.9/7,dpi=320)
